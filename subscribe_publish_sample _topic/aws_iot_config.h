...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "ajuxwbyl8gc90.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "MY_TH"//"AnnaIvanchikova"///"c-sdk-client-id" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		  "MY_THING" //"AWS-IoT-C-SDK" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "root.pem"//"rootCA.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "6a41a41d17-certificate.pem.crt"//"cert.pem" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "6a41a41d17-private.pem.key"//"privkey.pem" ///< Device private key filename
// =================================================
